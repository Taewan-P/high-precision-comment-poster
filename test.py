from cheer import get_cheer_id, cheer_fan
...
cheer_result = cheer_fan(cafe_id, cheer_id, 1)
...
assert cheer_result == True, f"Cheer Failed! - Expected True, but returned {cheer_result}"
